...
export class AppointmentService {
    ...
    static async create(body: CreateAppointmentBody) {
        try {
    ...
    static async update(appointmentId: number, body: UpdateAppointmentBody) {
        try {
            if (!appointmentId) {
    ...
    static async getByDoctor(doctorId: number) {
        try {
            if (!doctorId) {
    ...
    static async getAll(status?: AppointmentStatus) {
        try {
